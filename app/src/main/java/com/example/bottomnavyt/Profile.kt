...
class Profile : Fragment(),View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        val btn: FloatingActionButton = view.findViewById(R.id.add_expenses_button)
        btn.setOnClickListener(this)
        firebaseDatabase= FirebaseFirestore.getInstance()
        firebaseAuth=FirebaseAuth.getInstance()
        loadExpenses()
        recycleView=view.findViewById(R.id.expensesRecyclerView)
            ...
            override fun onClick(position: Int, model: User) {
                ...
                updateButton.setOnClickListener{
                    ...
                    saveButton.setOnClickListener{
                        ...
                        if (model.id!=null){
                            val ref=  firebaseDatabase.collection(firebaseAuth.currentUser!!.uid).document("expenses").collection("expenses").document(
    ...
    private fun loadExpenses(){
        ...
        firebaseDatabase.collection(firebaseAuth.currentUser!!.uid).document("expenses").collection("expenses").addSnapshotListener(object :
